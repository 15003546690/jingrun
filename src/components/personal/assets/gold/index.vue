  ...
  <div class="property_div">
    <div class="property_div_title">
      <div class="property_div_title_left">
        <p>金豆余额：{{balance.gold}}<img src="../../../../assets/img/center/venosa.png"/></p>
      </div>
...
export default{
	...
	methods: {
		...
		pageSize(){
			...
			this.$Bury(window.location.href,'',0,'jindoumingxiye_04006')
		},
		//金豆余额
		userBalance() {
...
.property_div_title_right>button{width: 68px;height: 23px;border: solid 1px #d9dbe1;border-radius: 2px;-webkit-border-radius: 2px;-moz-border-radius: 2px;font-size: 12px;color: #676767;float: left;margin-left: 23px;margin-top: 2px;outline: none;background: none;}
...
.property_div_content>table>tbody>tr>td{padding: 16px 0;border-bottom: solid 1px #eeeeee;text-align: center;}
