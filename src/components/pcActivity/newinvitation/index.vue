		...
		data() {
			...
			methods: {
				...
				newinvitaion() {
					...
					this.$CPOST('/activity/v1/invitation/userInvitationJanuary', {
...
<style scoped>
	* {
	...
	.new_invitaion {
		height: 654px;
		/*background: url(../../../assets/img/newinvitation/0-1.png) no-repeat center;*/
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_01.jpg) no-repeat center;
		background-size: cover;
	}
	
	.new_content {
		height: 706px;
		/*background: url(../../../assets/img/newinvitation/0-2.png) no-repeat center;*/
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_03.jpg) no-repeat center;
		background-size: cover;
	}
	...
	/*.new_content_center_top {
		height: 107px;
		text-align: center;
	}*/
	
	.new_content_center_body {
		height: 650px;
		/*background: url(../../../assets/img/newinvitation/123456_07.png) no-repeat center;*/
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_02.jpg) no-repeat center;
		overflow: hidden;
	}
	...
	.content_header_bg {
		...
		height: 200px;
		margin: 0 auto;
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_09.jpg) no-repeat center;
		background-size: cover;
		overflow: hidden;
	}
	
	.content_header_bg>span {
		width: 96px;
		height: 96px;
		border-radius: 8px;
		margin: 0 auto;
	...
	.right_p {
		/*background: url(../../../assets/img/newinvitation/565_04.png) no-repeat center;*/
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_04.jpg) no-repeat center;
		background-size: cover;
	}
	
	.right_pp {
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_05.jpg) no-repeat center;
		background-size: cover;
	}
	
	.right_ppp {
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_06.jpg) no-repeat center;
		background-size: cover;
	}
	
	.right_pv {
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_07.jpg) no-repeat center;
		background-size: cover;
	}
	
	.right_pvv {
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_08.jpg) no-repeat center;
		background-size: cover;
	}
	...
	.new_cont {
		height: 949px;
		/*background: url(../../../assets/img/newinvitation/5-08.png) no-repeat center;*/
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_12.jpg) no-repeat center;
		background-size: cover;
	}
	...
	*/
	...
	.new_cont_center_body {
		height: 780px;
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_13.jpg) no-repeat center;
		background-size: cover;
		position: relative;
		/*overflow: hidden;*/
		padding-top: 75px;
	...
	.center_body_pp {
		width: 284px;
		height: 91px;
		background: url(../../../../src/components/pcActivity/newinvitation/img/timer.png) no-repeat center;
		background-size: cover;
		padding-left: 6px;
	}
	...
	.car_thre_center_left {
		width: 376px;
		height: 312px;
		float: left;
	}
	
	.car_thre_center_center {
		width: 387px;
		height: 312px;
		float: left;
	}
	
	.car_thre_center_right {
		width: 375px;
		height: 312px;
		float: left;
	}
	
	.car_thre_center_left .btn_car_img,
	.car_thre_center_center .btn_car_img,
	.car_thre_center_right .btn_car_img {
		margin-top: 0;
	}
	
	.car_thre_center_left .btn_car_img p,
	.car_thre_center_center .btn_car_img p,
	.car_thre_center_right .btn_car_img p {
		font-size: 18px;
		color: #320b0d;
	}
	
	.car_thre_center_left .btn_car_img span,
	.car_thre_center_center .btn_car_img span,
	.car_thre_center_right .btn_car_img span {
		width: 376px;
		font-size: 18px;
		color: #320b0d;
		display: block;
	...
	.car_thre_center_left .btn_button,
	.car_thre_center_center .btn_button,
	.car_thre_center_right .btn_button {
		margin-top: 22px;
	}
	
	.new_map {
		height: 1337px;
		/*background: url(../../../assets/img/newinvitation/5-06.png) no-repeat center;*/
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_10.jpg) no-repeat center;
		background-size: cover;
	}
	
	.new_word {
		height: 937px;
		background: url(../../../../src/components/pcActivity/newinvitation/img/img_11.jpg) no-repeat center;
		/*background: #fff1d7;*/
		background-size: cover;
	}
	/*弹层*/
	...
	.confirm_main_or {
		...
		margin: auto;
		border-radius: 4px;
		background: url(../../../assets/img/newinvitation/car.jpg) no-repeat center;
		background-size: cover;
	}
	
	.confirm_hongbao .confirm_main_or {
		width: 100%;
		height: 100%;
		background: #fff;
		border: 1px solid #c9c9c9;
		margin: auto;
		border-radius: 4px;
		background: url(../../../assets/img/newinvitation/hongbao.jpg) no-repeat center;
		background-size: cover;
	}
	...
	.confirm_main_or .surebtn button {
		width: 179px;
		height: 68px;
		font-size: 20px;
		color: #808080;
	...
	.confirm_main_or .surebtn button+button {
		width: 179px;
		height: 68px;
		font-size: 20px;
		color: #e32f2a;
