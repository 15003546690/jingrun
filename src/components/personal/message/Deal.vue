...
<div>
	...
	<div class="listData" v-if="system.length>0">
		<div class="announcement" v-for="(item,index) in system" :data-id="item.messageId">
...
<style scoped>
#delAll{position: absolute;top: -48px;right: 0;font-size: 14px;color: #676767;cursor: pointer;}
.listData{width: 100%;height: 886px;position: relative;}
/*空白页*/
.noData{position: absolute;width: 77%;height: 100%;text-align: center;line-height: 1006px;}
