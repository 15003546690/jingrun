<template>
	<div class="solicitation">
		...
		<div class="solicitation_content">
			<img src="../../../../assets/img/chinese/images/two-content.png" alt="" />
		</div>
