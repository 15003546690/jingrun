...
<style scoped>
.confirm_box{width: 435px;height: 196px;background: #e6e6e6;position: absolute;left: 0; top: -380px;bottom: 0;right: 0;margin: auto;z-index: 1000;}
...
.confirm_btn>button{width: 98px;height: 32px;background: #f0080a; border: 0;outline: none;color: #fff;font-size: 14px;cursor: pointer;}
.confirm_btn>button:nth-child(1){float: left;margin-left: 80px;}
.confirm_btn>button:nth-child(2){float: right;margin-right: 80px;}
</style>